...
public class billing extends javax.swing.JFrame {
  ...
  public void update(){
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\ICON\\icons8-billing-50.png")); // NOI18N
        jLabel1.setText("BILLING");

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 0, 255));
        jLabel2.setText("Buyer Detail");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Buyer Name", "Buyer No", "Product Name", "Rate", "active"
            }
        ));
        ...
        jLabel12.setText("Calculation Detail");
        ...
        jButton5.setIcon(new javax.swing.ImageIcon("C:\\ICON\\icons8-cancel-24.png")); // NOI18N
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
             try {
            ps=con.prepareStatement("SELECT `id`, `name`, `contact no`, `email`, `address`  FROM `record` WHERE id=? ");
          ...
          jTextField2.setText(rs.getString("contact no"));
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
            ...
            jTextField5.setText(rs.getString("p name"));
          jTextField6.setText(rs.getString("rate"));
           jTextField7.setText(rs.getString("description"));
          jTextField8.setText(rs.getString("active"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            // TODO add your handling code here:
            ps=con.prepareStatement("INSERT INTO `bill`( `name`, `contact no`, `email`, `address`, `p name`, `rate`, `description`, `active`) VALUES (?,?,?,?,?,?,?,?)");
