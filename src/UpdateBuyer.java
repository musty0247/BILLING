...
Connection con=mycon.getConnection();
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Update Buyer", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 24), new java.awt.Color(0, 0, 255))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ResultSet rs;
             try {
            ps=con.prepareStatement("SELECT `id`, `name`, `contact no`, `email`, `address`, `gender` FROM `record` WHERE id=?");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
            ...
            ps=con.prepareStatement("UPDATE `record` SET `name`=?,`contact no`=?,`email`=?,`address`=?,`gender`=? WHERE id=?");
