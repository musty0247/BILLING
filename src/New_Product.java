...
public class New_Product extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String active=jComboBox1.getSelectedItem().toString();
        
        try {
            ps=con.prepareStatement("INSERT INTO `product`( `p name`, `rate`, `description`, `active`) VALUES (?,?,?,?) ");
            ps.setString(1, jTextField1.getText());
             ps.setString(2, jTextField2.getText());
              ...
              if(ps.executeUpdate() !=0){
                  JOptionPane.showMessageDialog(null, "NEW PRODUCT IS ADDED");
